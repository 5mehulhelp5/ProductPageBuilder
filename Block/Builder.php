...
class Builder extends \Cytracon\Builder\Block\Builder
{
     ...
     * @param \Cytracon\ProductPageBuilder\Model\CompositeConfigProvider $configProvider
     * @param array                                                     $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Cytracon\ProductPageBuilder\Model\CompositeConfigProvider $configProvider,
        array $data = []
    ) {
