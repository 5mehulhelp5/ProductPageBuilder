...
namespace Cytracon\ProductPageBuilder\Block\Product;
...
class Element extends \Cytracon\Builder\Block\Element
{
    ...
    protected function _construct()
    {
        ...
        if ($this->getData('enable_cache')) {
            $this->addData([
                ...
                'cache_tags' => [
                    \Cytracon\ProductPageBuilder\Model\Profile::CACHE_TAG,
    ...
    /**
     * @return \Cytracon\ProductPageBuilder\Model\Profile
     */
