...
namespace Cytracon\ProductPageBuilder\Controller\Adminhtml\Profile;

use Magento\Framework\App\Request\DataPersistorInterface;
use Magento\Framework\Exception\LocalizedException;
use Cytracon\ProductPageBuilder\Model\Processor;
...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Cytracon_ProductPageBuilder::profile_save';
    ...
    /**
     * @var \Cytracon\SizeChart\Model\Processor
     */
    protected $processor;
    ...
    public function execute()
    {
        ...
        if ($data) {
            /** @var \Cytracon\ProductPageBuilder\Model\Profile $model */
            $model = $this->_objectManager->create(\Cytracon\ProductPageBuilder\Model\Profile::class);
            ...
            try {
                ...
                if ($redirectBack === 'save_and_duplicate') {
                    $duplicate = $this->_objectManager->create(\Cytracon\ProductPageBuilder\Model\Profile::class);
